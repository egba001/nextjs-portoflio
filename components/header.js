...
const Header = () => {
    ...
    return (
        <div className="h-screen w-full relative">
            <div className="bg-darkGray p-6 md:p-0 md:py-10 w-full flex items-center justify-between">
                <Link href='/'>
            ...
            <div className='max-w-full mx-4 h-fit mt-10'>
            ...
            <div className="flex gap-1 mx-4 max-w-full flex-wrap mt-12 space-x-3 text-white break-before-right absolute md:bottom-28 ">
