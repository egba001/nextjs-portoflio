  ...
  return (
    <div className='px-4 text-white flex justify-center h-full pt-32 font-thin mb-24'>
        <div className="max-w-5xl px-2">
            <h2 className="text-5xl mb-14">Frontend Developer with a <span className="border-b-8 font-extrabold border-b-pink-500">Knack</span> for crafting pixel perfect User Interface</h2>
